...
static void handleCallbackTimestampBatch(int32_t, const std::vector<HandleTimestampMessage>&, void*) {
    /* Empty */
}
...
status_t CameraHardwareInterfaceFlashControl::connectCameraDevice(
    ...
    device->setCallbacks(notifyCallback, dataCallback, dataCallbackTimestamp, handleCallbackTimestampBatch, this);
