...
public:
    class AcousticsContext : public RefBase {
    public:
        AcousticsContext(
    ...
    class AcousticsContextManager : public RefBase {
    public:
        AcousticsContextManager(AudioPolicyInterface *pAudioPolicyManager);
        virtual ~AcousticsContextManager();

        static bool isAcousticsEffect(const effect_descriptor_t *desc);
        static bool isMasterIo(const audio_io_handle_t io);

        bool isAcousticsEffect(const int id) const;
    ...
    private:
        ...
        sp<AcousticsContext> getEffect(const int id) const;
        sp<AcousticsContext> getEffectOnIo(const audio_io_handle_t io) const;
        sp<AcousticsContext> getMasterEffect() const;
        ...
        AudioPolicyInterface *mAudioPolicyManager;
        KeyedVector< int, sp<AcousticsContext> > m_vIdToAcousticsContext;

        mutable Mutex mLock;
    };

    sp<AcousticsContextManager> mAcousticsContextManager;
#endif
};
